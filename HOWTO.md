...
Also, let's set up MAVProxy to get our Telem2 connection working. MAVProxy will route the telemetry into two streams: one for Executor, and another to allow you to use QGroundControl wirelessly by connecting to the access point.
